...
export default function StudentsPage() {
  ...
  // Submit attendance using mutation - FIXED with correct structure
  const submitAttendance = async () => {
    ...
    // Correct payload structure based on your working example
  ...
  // Submit exam results using mutation - FIXED with correct structure
  const submitExamResults = async () => {
    ...
    // Correct payload structure for exam results
  ...
  const renderActions = (item: ClassItem) => (
    <div className="flex items-center space-x-2">
      ...
      {/* Exam Results Action */}
      <button
        onClick={() => handleExamResults(item)}
